# Zero-Trust Audit — 20260501T174438Z

- Receipts scanned: **213**
- CRITICAL: **9**
- WARN: 72
- INFO: 62
...
### L4_orphan_fail — 1
- `results/experiments/exp162_sigma_bigram_universal/exp162_sigma_bigram_universal.json` — Receipt with verdict FAIL_BIGRAM_NOT_UNIVERSAL but experiment name exp162_sigma_bigram_universal not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_BIGRAM_NOT_UNIVERSAL)

### L7_f_cite_nonexistent_receipt — 6
- `` — F86 cites receipt exp176_mushaf_tour which does not exist.  (f_number=86; cited_receipt=exp176_mushaf_tour)
- `` — F85 cites receipt exp176_mushaf_tour which does not exist.  (f_number=85; cited_receipt=exp176_mushaf_tour)
- `` — F84 cites receipt exp176_mushaf_tour which does not exist.  (f_number=84; cited_receipt=exp176_mushaf_tour)
- `` — F83 cites receipt exp176_mushaf_tour which does not exist.  (f_number=83; cited_receipt=exp176_mushaf_tour)
- `` — F82 cites receipt exp176_mushaf_tour which does not exist.  (f_number=82; cited_receipt=exp176_mushaf_tour)
- `` — F81 cites receipt exp176_mushaf_tour which does not exist.  (f_number=81; cited_receipt=exp176_mushaf_tour)

### L7_f_cites_non_pass — 2
- `` — F89 cites receipt exp179_F85_escalation_10M whose verdict is  (not PASS_ and no retraction marker in row body)  (f_number=89; cited_receipt=exp179_F85_escalation_10M; verdict=)
- `` — F88 cites receipt exp178_quran_portrait whose verdict is  (not PASS_ and no retraction marker in row body)  (f_number=88; cited_receipt=exp178_quran_portrait; verdict=)
