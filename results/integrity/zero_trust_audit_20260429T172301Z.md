# Zero-Trust Audit — 20260429T172301Z

- Receipts scanned: **180**
- CRITICAL: **1**
- WARN: 63
- INFO: 53
...
### L4_orphan_fail — 1
- `results/experiments/exp125_unified_quran_coordinate_pca/exp125_unified_quran_coordinate_pca.json` — Receipt with verdict FAIL_no_unification but experiment name exp125_unified_quran_coordinate_pca not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_no_unification)

## WARN (63)

### L6_no_calibration_source_declared — 63
