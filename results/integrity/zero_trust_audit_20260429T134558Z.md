# Zero-Trust Audit — 20260429T134558Z

- Receipts scanned: **175**
- CRITICAL: **2**
- WARN: 62
- INFO: 53
...
- `` — F73 cites receipt exp121_trigram_verse_reorder whose verdict is PARTIAL_F70_gap_partially_closed (not PASS_ and no retraction marker in row body)  (f_number=73; cited_receipt=exp121_trigram_verse_reorder; verdict=PARTIAL_F70_gap_partially_closed)
- `` — F72 cites receipt exp120_unified_quran_code whose verdict is PARTIAL_quran_rank_1_perm_p_above_0p05 (not PASS_ and no retraction marker in row body)  (f_number=72; cited_receipt=exp120_unified_quran_code; verdict=PARTIAL_quran_rank_1_perm_p_above_0p05)

## WARN (62)

### L6_no_calibration_source_declared — 62
