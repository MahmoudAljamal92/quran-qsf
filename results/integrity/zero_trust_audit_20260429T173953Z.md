# Zero-Trust Audit — 20260429T173953Z

- Receipts scanned: **182**
- CRITICAL: **2**
- WARN: 64
- INFO: 55
...
- `results/experiments/exp124b_alphabet_corrected_one_bit_universal/exp124b_alphabet_corrected_one_bit_universal.json` — Receipt cites exp114_alphabet_independent_pmax which has a FAIL_* verdict. Either remove the citation or document why a failed result is being relied upon.  (citing_verdict=PARTIAL_quran_top_but_threshold_breached; cited_dep=exp114_alphabet_independent_pmax; dep_verdict=FAIL_perm_p_floor_at_1_over_N)

### L4_orphan_fail — 1
- `results/experiments/exp125c_RG_scaling_alpha_unification/exp125c_RG_scaling_alpha_unification.json` — Receipt with verdict FAIL_no_alpha_unification but experiment name exp125c_RG_scaling_alpha_unification not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_no_alpha_unification)

## WARN (64)

### L6_no_calibration_source_declared — 64
...
- `results/experiments/exp111_F63_rigveda_falsification/exp111_F63_rigveda_falsification.json` — Receipt exp111_F63_rigveda_falsification is not referenced from any of RANKED_FINDINGS / PROGRESS / PAPER / REFERENCE.
...
- `results/experiments/exp124b_alphabet_corrected_one_bit_universal/exp124b_alphabet_corrected_one_bit_universal.json` — Receipt exp124b_alphabet_corrected_one_bit_universal is not referenced from any of RANKED_FINDINGS / PROGRESS / PAPER / REFERENCE.
