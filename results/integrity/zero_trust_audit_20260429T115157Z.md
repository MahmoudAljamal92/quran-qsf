# Zero-Trust Audit — 20260429T115157Z

- Receipts scanned: **173**
- CRITICAL: **2**
- WARN: 62
- INFO: 53
...
### L4_orphan_fail — 1
- `results/experiments/exp114_alphabet_independent_pmax/exp114_alphabet_independent_pmax.json` — Receipt with verdict FAIL_audit_perm_p_floor_at_1_over_N but experiment name exp114_alphabet_independent_pmax not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_audit_perm_p_floor_at_1_over_N)

### L5_audit_fail_but_audit_ok — 1
- `results/experiments/exp114_alphabet_independent_pmax/exp114_alphabet_independent_pmax.json` — FAIL_audit verdict but audit_report.ok is truthy. Logic error.  (verdict=FAIL_audit_perm_p_floor_at_1_over_N; audit_ok=True)
