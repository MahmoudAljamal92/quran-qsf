# Zero-Trust Audit — 20260428T164555Z

- Receipts scanned: **154**
- CRITICAL: **12**
- WARN: 51
- INFO: 57
...
### L2_stale_dep_missing — 1
- `results/experiments/exp95f_short_envelope_replication/exp95f_short_envelope_replication.json` — Receipt cites results/experiments/exp95e_full_114_consensus_universal/ but it does not exist on disk.  (cited_dep=exp95e_full_114_consensus_universal)

### L4_orphan_fail — 11
- `results/experiments/exp103_cross_compressor_gamma/exp103_cross_compressor_gamma.json` — Receipt with verdict FAIL_not_universal but experiment name exp103_cross_compressor_gamma not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_not_universal)
- `results/experiments/exp89_lc3_ablation/exp89_lc3_ablation.json` — Receipt with verdict FAIL_T_dominates but experiment name exp89_lc3_ablation not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_T_dominates)
- `results/experiments/exp90_cross_language_el/exp90_cross_language_el.json` — Receipt with verdict FAIL_no_convergence but experiment name exp90_cross_language_el not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_no_convergence)
- `results/experiments/exp91_meccan_medinan_stability/exp91_meccan_medinan_stability.json` — Receipt with verdict FAIL_crossing_gap but experiment name exp91_meccan_medinan_stability not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_crossing_gap)
- `results/experiments/exp95h_asymmetric_detector/exp95h_asymmetric_detector.json` — Receipt with verdict FAIL_no_clean_split_p90 but experiment name exp95h_asymmetric_detector not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_no_clean_split_p90)
- `results/experiments/exp95i_bigram_shift_detector/exp95i_bigram_shift_detector.json` — Receipt with verdict FAIL_audit_hook_violated but experiment name exp95i_bigram_shift_detector not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_audit_hook_violated)
- `results/experiments/exp95k_msfc_amplification/exp95k_msfc_amplification.json` — Receipt with verdict FAIL_audit_quran_drift but experiment name exp95k_msfc_amplification not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_audit_quran_drift)
- `results/experiments/exp95m_msfc_phim_fragility/exp95m_msfc_phim_fragility.json` — Receipt with verdict FAIL_audit_features_drift but experiment name exp95m_msfc_phim_fragility not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_audit_features_drift)
- `results/experiments/exp95n_msfc_letter_level_fragility/exp95n_msfc_letter_level_fragility.json` — Receipt with verdict FAIL_quran_not_top_1 but experiment name exp95n_msfc_letter_level_fragility not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_quran_not_top_1)
- `results/experiments/exp95o_joint_extremum_likelihood/exp95o_joint_extremum_likelihood.json` — Receipt with verdict FAIL_audit_el_rate_quran_drift but experiment name exp95o_joint_extremum_likelihood not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_audit_el_rate_quran_drift)
- `results/experiments/exp99_lc4_el_sufficiency/exp99_lc4_el_sufficiency.json` — Receipt with verdict FAIL_alignment_below_gate but experiment name exp99_lc4_el_sufficiency not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_alignment_below_gate)

## WARN (51)

### L6_no_calibration_source_declared — 51
...
- `results/experiments/exp87_unified_probe/exp87_unified_probe.json` — Receipt carries a tau/threshold-style field but declares no calibration_source. Cannot verify that calibration is independent of the test fold.
- `results/experiments/exp89_lc3_ablation/exp89_lc3_ablation.json` — Receipt carries a tau/threshold-style field but declares no calibration_source. Cannot verify that calibration is independent of the test fold.
- `results/experiments/exp90_cross_language_el/exp90_cross_language_el.json` — Receipt carries a tau/threshold-style field but declares no calibration_source. Cannot verify that calibration is independent of the test fold.
- ... and 21 more

## INFO (57)

### L8_orphan_receipt — 57
...
- `results/experiments/exp07_tension_law/exp07_tension_law.json` — Receipt exp07_tension_law is not referenced from any of RANKED_FINDINGS / PROGRESS / PAPER / REFERENCE.
