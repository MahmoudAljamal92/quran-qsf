# Zero-Trust Audit — 20260428T175523Z

- Receipts scanned: **156**
- CRITICAL: **7**
- WARN: 53
- INFO: 49
...
### L7_f_cites_non_pass — 7
- `` — F45 cites receipt expP11_brown_empirical_corr whose verdict is TIGHTENED_STRONG (not PASS_).  (f_number=45; cited_receipt=expP11_brown_empirical_corr; verdict=TIGHTENED_STRONG)
- `` — F46 cites receipt expP12_bootstrap_t2_ci whose verdict is STABLE (not PASS_).  (f_number=46; cited_receipt=expP12_bootstrap_t2_ci; verdict=STABLE)
- `` — F47 cites receipt expP13_loco_el whose verdict is ROBUST_STRONG (not PASS_).  (f_number=47; cited_receipt=expP13_loco_el; verdict=ROBUST_STRONG)
- `` — F48 cites receipt expP15_riwayat_invariance whose verdict is RIWAYAT_DEPENDENT (not PASS_).  (f_number=48; cited_receipt=expP15_riwayat_invariance; verdict=RIWAYAT_DEPENDENT)
- `` — F49 cites receipt expP15_riwayat_invariance whose verdict is RIWAYAT_DEPENDENT (not PASS_).  (f_number=49; cited_receipt=expP15_riwayat_invariance; verdict=RIWAYAT_DEPENDENT)
- `` — F50 cites receipt expP16_maqamat_hariri whose verdict is QURAN_DISTINCT_FROM_SAJ (not PASS_).  (f_number=50; cited_receipt=expP16_maqamat_hariri; verdict=QURAN_DISTINCT_FROM_SAJ)
- `` — F54 cites receipt exp95e_full_114_consensus_universal whose verdict is FAIL_per_surah_floor (not PASS_).  (f_number=54; cited_receipt=exp95e_full_114_consensus_universal; verdict=FAIL_per_surah_floor)

## WARN (53)

### L6_no_calibration_source_declared — 53
