# Zero-Trust Audit — 20260501T174637Z
...
### L7_f_cites_non_pass — 5
- `` — F85 cites receipt exp176_mushaf_tour whose verdict is CONFIRM (not PASS_ and no retraction marker in row body)  (f_number=85; cited_receipt=exp176_mushaf_tour; verdict=CONFIRM)
- `` — F84 cites receipt exp176_mushaf_tour whose verdict is CONFIRM (not PASS_ and no retraction marker in row body)  (f_number=84; cited_receipt=exp176_mushaf_tour; verdict=CONFIRM)
- `` — F83 cites receipt exp176_mushaf_tour whose verdict is CONFIRM (not PASS_ and no retraction marker in row body)  (f_number=83; cited_receipt=exp176_mushaf_tour; verdict=CONFIRM)
- `` — F82 cites receipt exp176_mushaf_tour whose verdict is CONFIRM (not PASS_ and no retraction marker in row body)  (f_number=82; cited_receipt=exp176_mushaf_tour; verdict=CONFIRM)
- `` — F81 cites receipt exp176_mushaf_tour whose verdict is CONFIRM (not PASS_ and no retraction marker in row body)  (f_number=81; cited_receipt=exp176_mushaf_tour; verdict=CONFIRM)
...
- `` — F86 cites receipt exp176_mushaf_tour whose verdict is CONFIRM (intentional — F-row documents retraction)  (f_number=86; cited_receipt=exp176_mushaf_tour; verdict=CONFIRM)
