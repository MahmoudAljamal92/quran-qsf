# Zero-Trust Audit — 20260428T182344Z

- Receipts scanned: **157**
- CRITICAL: **2**
- WARN: 54
- INFO: 51
...
### L4_orphan_fail — 1
- `results/experiments/exp104b_F53_psalm119/exp104b_F53_psalm119.json` — Receipt with verdict FAIL_audit_peer_pool_size but experiment name exp104b_F53_psalm119 not mentioned in RETRACTIONS_REGISTRY.md. Add an entry or reclassify the verdict.  (verdict=FAIL_audit_peer_pool_size)

### L5_audit_fail_but_audit_ok — 1
- `results/experiments/exp104b_F53_psalm119/exp104b_F53_psalm119.json` — FAIL_audit verdict but audit_report.ok is truthy. Logic error.  (verdict=FAIL_audit_peer_pool_size; audit_ok=True)

## WARN (54)

### L6_no_calibration_source_declared — 54
...
- `results/experiments/exp104b_F53_psalm119/exp104b_F53_psalm119.json` — Receipt exp104b_F53_psalm119 is not referenced from any of RANKED_FINDINGS / PROGRESS / PAPER / REFERENCE.
