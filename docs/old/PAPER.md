...
> **⚠ DEPRECATED — legacy v3.0 PAPER (2026-04-17). SUPERSEDED by `../PAPER.md` v7.5.**
>
> This file (`docs/old/PAPER.md`, 21 kB) is the **original clean-data-rebuild v3.0 manuscript** preserved in `docs/old/` for audit-trail integrity. **It is not the current paper.** The body below uses Cohen's d = 6.34 as the multivariate headline (deprecated as biased in v5+), reports AUC = 0.998 without Band-A restriction context (Band-A reducing Quran to 68/114 surahs was added in v3), and predates every finding in v5 / v6 / v7 / v7.1 / v7.2 / v7.3 / v7.4 / v7.5 — including the Hotelling T² = 3 557 headline, R12 gzip NCD γ = +0.0716 edit-detection channel, Adiyat 864-variant compound test, exp45 two-letter enumeration, exp46 emphatic-class audit, exp48 verse-graph topology, the exp49 6-D Hotelling closure, exp50 `H2_QURAN_SPECIFIC_IMMUNITY` cross-corpus result, exp51 poetry_islami sensitivity, and the four-manifest SHA-256 integrity-lock protocol with 127 locked scalars.
>
> **For the current paper use `../PAPER.md` (v7.5).** This v3.0 file is retained only so that the 2026-04-17 arXiv preprint can be cited verbatim. If you are looking for a "PAPER_DRAFT" referred to in review comments, this file is what that label means — it is not a separate paper, it is the legacy v3.0 paper under a legacy name.
>
> *Banner added 2026-04-21 as part of the v7.5.1 doc-reconciliation patch.*
...
**Status**: **SUPERSEDED by `docs/PAPER.md` v7.5 (2026-04-21 evening)**. Retained as a frozen v3.0 record.
